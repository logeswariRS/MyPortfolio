...
export default function Layout({ headerStyle, footerStyle, breadcrumbText, breadcrumbTitle, children, wrapperCls }) {
    ...
    return (
        <>
            ...
            <div className={`page-wrapper ${wrapperCls ? wrapperCls : ""}`} id="#top">
                ...
                {breadcrumbText && <Breadcrumb breadcrumbText={breadcrumbText} />}
